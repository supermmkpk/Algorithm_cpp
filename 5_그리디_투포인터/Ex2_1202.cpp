...
/*
 * 1_문자열_누적합_구현) 보석이 N개, 가방 K개 (1_문자열_누적합_구현 ≤ N, K ≤ 300,000)
 * N개 줄) 무게 Mi, 가격 Vi (0 ≤ Mi, Vi ≤ 1e6)
 * K개 줄) 가방에 담을 수 있는 최대 무게 Ci (1_문자열_누적합_구현 ≤ Ci ≤ 1e8)
 * 모든 숫자는 양의 정수이다.
...
int main(void) {
    ...
    vector<int> bagV; //가방에 담을 수 있는 최대 무게 Ci (1_문자열_누적합_구현 ≤ Ci ≤ 1e8)
    for(int i = 0; i < n; i++) {
        int m, v;
        cin >> m >> v;
